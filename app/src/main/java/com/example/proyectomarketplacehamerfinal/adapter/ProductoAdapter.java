package com.example.proyectomarketplacehamerfinal.adapter;
...
import android.widget.ImageView; // Importado aunque no se usa en el código final de la P.84 (se usa en P.44)
import android.widget.TextView;
import android.widget.Toast; // Importado en P.82

import androidx.annotation.NonNull;
import androidx.recyclerview.widget.RecyclerView;

import com.example.proyectomarketplacehamerfinal.Detalle_Producto;
import com.example.proyectomarketplacehamerfinal.R;
import com.example.proyectomarketplacehamerfinal.model.Producto;
...
public class ProductoAdapter extends
    ...
    public static class ProductoViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvNombre;
        TextView tvPrecio;
        // La variable ivImagen se omite en P.84 pero se incluye en P.44
        // ImageView ivImagen;

        public ProductoViewHolder(@NonNull View itemView) {
            super(itemView);
            // Conexión con los IDs de res/layout/item_producto.xml
            // ivImagen = itemView.findViewById(R.id.iv_producto_imagen); // Omitido en P.84
