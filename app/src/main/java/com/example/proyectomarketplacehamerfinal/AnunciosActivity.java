...
import com.example.proyectomarketplacehamerfinal.adapter.ProductoAdapter;
...
Toast.LENGTH_SHORT).show();
 return true;
    ...
    private List<Producto> cargarProductosDePrueba() {
        ...
        lista.add(new Producto("ID003", "Libro: El Señor de los Anillos", "Edición de lujo tapdura.", "29.990", "url_ficticia_3"));
