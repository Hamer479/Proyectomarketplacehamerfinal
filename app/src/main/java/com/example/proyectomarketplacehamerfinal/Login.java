...
import com.example.proyectomarketplacehamerfinal.Home;
import com.example.proyectomarketplacehamerfinal.Registro;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvlrRegistro = findViewById(R.id.tv_link_registro);
        ...
        tvlrRegistro.setOnClickListener(v -> irARegistro()); // <-- MODIFICACIÓN SEMANA 3: Uso de método auxiliar
    }
