...
import com.example.proyectomarketplacehamerfinal.Login;
...
public class Registro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvlrLogin = findViewById(R.id.tv_link_login);
        ...
        tvlrLogin.setOnClickListener(v -> irALogin());
    }
